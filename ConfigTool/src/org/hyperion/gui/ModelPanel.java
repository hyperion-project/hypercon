...
import org.hyperion.model.Parameter;
...
import org.hyperion.model.util.ModelUtil;
...
public class ModelPanel extends JPanel {
	...
	private void initialise() {
		if (mModel instanceof ModelList) {
			@SuppressWarnings("unchecked")
			final ModelList<AbstractModel> list = (ModelList<AbstractModel>) mModel;
			final Class<?> elementClass = list.get(0).getClass();
			...
			add(modelListEditor, BorderLayout.CENTER);
